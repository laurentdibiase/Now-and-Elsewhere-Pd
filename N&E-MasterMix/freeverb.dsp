...
dampSlider      = hslider("Damp",0.2, 0, 1, 0.01)*scaledamp;
roomsizeSlider  = hslider("RoomSize", 0.6, 0, 1, 0.01)*scaleroom + offsetroom;
wetSlider       = hslider("Wet", 0.3, 0, 1, 0.01): si.smoo;
