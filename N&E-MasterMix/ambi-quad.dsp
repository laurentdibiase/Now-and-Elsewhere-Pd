...
process(sig1, sig2, sig3, sig4, sig5, sig6) = ho.map(1, sig1, r1, a1), ho.map(1, sig2, r2, a2), ho.map(1, sig3, r3, a3), ho.map(1, sig4, r4, a4), ho.map(1, sig5, r5, a5), ho.map(1, sig6, r6, a6) :> ho.optimInPhase(1) <: (ho.decoder(1, 4));
