...
combfeed = hslider("RoomSize",0.6,0,1,0.025)*scaleroom*ma.SR/origSR + offsetroom;
damping = hslider("Damp",0.2,0,1,0.025)*scaledamp*ma.SR/origSR;
spatSpread = hslider("Spread",0.5,0,1,0.01)*46*ma.SR/origSR;
g = hslider("Wet",0.3,0,1,0.01): si.smoo;
